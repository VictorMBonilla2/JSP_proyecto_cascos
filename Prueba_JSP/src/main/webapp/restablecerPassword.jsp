        ...
        <div class="Inputs_Container">
            <form id="recovery" class="formulario_login">
                ...
                <div class="input_container">
                    <input type="password" id="password" placeholder="Ingresa tu nueva contraseña" name="password" required>
                </div>
...
<script type="module" src="resources/js/resetPassword.js"></script>
</body>
